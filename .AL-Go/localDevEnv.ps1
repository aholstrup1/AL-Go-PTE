...
$webClient.DownloadFile('https://raw.githubusercontent.com/aholstrup1/AL-Go-Actions/v46/Github-Helper.psm1', $GitHubHelperPath)
Write-Host "Downloading AL-Go Helper script"
$ALGoHelperPath = "$([System.IO.Path]::GetTempFileName()).ps1"
$webClient.DownloadFile('https://raw.githubusercontent.com/aholstrup1/AL-Go-Actions/v46/AL-Go-Helper.ps1', $ALGoHelperPath)
