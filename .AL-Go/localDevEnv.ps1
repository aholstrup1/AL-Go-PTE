...
$webClient.DownloadFile('https://raw.githubusercontent.com/aholstrup1/AL-Go/0f935b427a2c43ecbee720d82648eea82b4cf204/Actions/Github-Helper.psm1', $GitHubHelperPath)
Write-Host "Downloading AL-Go Helper script"
$ALGoHelperPath = "$([System.IO.Path]::GetTempFileName()).ps1"
$webClient.DownloadFile('https://raw.githubusercontent.com/aholstrup1/AL-Go/0f935b427a2c43ecbee720d82648eea82b4cf204/Actions/AL-Go-Helper.ps1', $ALGoHelperPath)
